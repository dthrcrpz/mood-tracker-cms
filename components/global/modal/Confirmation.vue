            ...
            <div class="wrapper">
                <div :class="[ 'content', getItem.action ]">
                    ...
                    <div class="content_bottom">
                        <div class="inline">
                            <div class="cancel_button outline pointer" @click="toggleModalStatus({ type: 'confirmation', status: false })">Cancel</div>
                            <div class="warning_button pointer ml ten" @click="confirm()">Continue</div>
                        </div>
                    </div>
                </div>
