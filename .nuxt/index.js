...
import nuxt_plugin_plugin_480f453d from 'nuxt_plugin_plugin_480f453d' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_axios_37e9a3d3 from 'nuxt_plugin_axios_37e9a3d3' // Source: ./axios.js (mode: 'all')
import nuxt_plugin_vuescrollto_53dc20e5 from 'nuxt_plugin_vuescrollto_53dc20e5' // Source: ../plugins/vue-scrollto (mode: 'client')
import nuxt_plugin_vuemultiselect_f0c5f110 from 'nuxt_plugin_vuemultiselect_f0c5f110' // Source: ../plugins/vue-multiselect (mode: 'client')
...
import nuxt_plugin_vuelineclamp_7c690d3f from 'nuxt_plugin_vuelineclamp_7c690d3f' // Source: ../plugins/vue-line-clamp (mode: 'client')
...
import nuxt_plugin_vuequilleditor_67e94cdc from 'nuxt_plugin_vuequilleditor_67e94cdc' // Source: ../plugins/vue-quill-editor (mode: 'client')
import nuxt_plugin_mixins_5013a1f0 from 'nuxt_plugin_mixins_5013a1f0' // Source: ../plugins/mixins (mode: 'all')
import nuxt_plugin_auth_581cbefd from 'nuxt_plugin_auth_581cbefd' // Source: ./auth.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"admin-template","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Flogo.png"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_480f453d === 'function') {
    await nuxt_plugin_plugin_480f453d(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_37e9a3d3 === 'function') {
    await nuxt_plugin_axios_37e9a3d3(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_vuemultiselect_f0c5f110 === 'function') {
  ...
  if (process.client && typeof nuxt_plugin_vuelineclamp_7c690d3f === 'function') {
    await nuxt_plugin_vuelineclamp_7c690d3f(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_vuequilleditor_67e94cdc === 'function') {
    await nuxt_plugin_vuequilleditor_67e94cdc(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_auth_581cbefd === 'function') {
    await nuxt_plugin_auth_581cbefd(app.context, inject)
  }
